											...
											<table class="table table-hover demo-table-dynamic custom">
												...
												@endforeach
														<tr>
															...
															<td></td>
															<td></td>
															<td><b>{{ $mil->luas_lahan}} M<sup>2</sup> <?php echo "(", round($luas_lahan,2), "Ha)";  ?></b></td>
															<td><b>{{ $mil->kondisi_rusak }} M<sup>2</sup> <?php echo "(", round($kondisi_rusak,2), "Ha)"; ?></b></td>
															<td><b>{{ $mil->kondisi_sedang }} M<sup>2</sup> <?php echo "(", round($kondisi_sedang,2), "Ha)"; ?></b></td>
															<td><b>{{ $mil->kondisi_baik }} M<sup>2</sup> <?php echo "(", round($kondisi_baik,2), "Ha)"; ?></b></td>
															<td></td>
														</tr>
												</tbody>

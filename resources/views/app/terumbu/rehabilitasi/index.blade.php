...
@section('title')
	Luas Lahan Terumbu Karang yang direhabilitasi| Tambah
@endsection
					...
					<div class="row">
							...
							<div class="col-lg-7 col-md-6 ">
								...
								<div class="panel panel-transparent">
									<div class="panel-body">
										<form id="form-personal" method="GET" action="{{ route('terumburehabilitasi_add') }}" role="form">
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="">
										<form action="{{ url('/app/terumbu/rehabilitasi') }}">
											<div class="col-md-4">
										...
										<div id="show-data">
											...
											<center>{!! $terumburehabilitasi->appends([ 'offset' => $_GET['offset'], 'limit' => $_GET['limit'] ])->links() !!}</center>
										</div>
		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<a href="{{ url('/app/terumbu/rehabilitasi/export-excel?offset='.$_GET['offset'].'&limit='.$_GET['limit']) }}">
								<i class="fa fa-file-excel-o export-excel"></i>
								Unduh Dalam Format Mic.Excel
							</a>
						</div>
						<div class="col-md-6">
							<a href="{{ url('/app/terumbu/rehabilitasi/export-pdf?offset='.$_GET['offset'].'&limit='.$_GET['limit']) }}">
	...
	<script>
		...
		$(function(){
			...
			$(".panel").on('click', '.view', function(){
				var id = $(this).data('id');
				var url = "{{ route('terumburehabilitasi_detail') }}";
				var url = url+'/'+id;
		...
		function cari_data(cari){
			if ( cari == "" ) {
				...
				var _token = $('meta[name="csrf-token"]').attr('content');
				var url = "{{ url('app/terumbu/rehabilitasi/search') }}";
				var url = url+"/"+cari;

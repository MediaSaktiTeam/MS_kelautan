					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<form class="style-form" action="{{ route('prov_update') }}">
									<div class="col-md-6">
										<input type="hidden" name="id_prov" value="{{ $prov->id }}">
										<input type="hidden" name="id_kab" value="{{ $kab->id }}">
										<br>
										<h6><b>Provinsi</b></h6>
										<div class="form-group form-group-default input-group">
											<input type="text" name="prov" class="form-control" value="{{ $prov->id }}" style="margin-top: 13px;">
									...
									<div class="col-md-6">
										...
										<h6><b>Kabupaten</b></h6>
										<div class="form-group form-group-default input-group">
											<input type="text" name="kab" class="form-control" value="{{ $kab->id }}" style="margin-top: 13px;">

					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="">
										<form action="{{ url('/app/mangrove/rehabilitasi') }}">
											<div class="col-md-4">
										...
										<div id="show-data">
											...
											<center>{!! $mangrovejenis->appends([ 'offset' => $_GET['offset'], 'limit' => $_GET['limit'] ])->links() !!}</center>
										</div>
		...
		<div class="modal-content-wrapper">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<a href="{{ url('/app/mangrove/jenis/export-excel?offset='.$_GET['offset'].'&limit='.$_GET['limit']) }}">
								<i class="fa fa-file-excel-o export-excel"></i>
								Unduh Dalam Format Mic.Excel
							</a>
						</div>
						<div class="col-md-6">
							<a href="{{ url('/app/mangrove/jenis/export-pdf?offset='.$_GET['offset'].'&limit='.$_GET['limit']) }}">
	...
	<script>
		...
		function cari_data(cari){
			if ( cari == "" ) {
				...
				var _token = $('meta[name="csrf-token"]').attr('content');
				var url = "{{ url('app/mangrove/jenis/search') }}";
				var url = url+"/"+cari;

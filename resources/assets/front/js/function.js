...
$('.blog-header,.front-header,.fixed-header').find('.nav li').hover(function(){
 ...
 $(this).find('ul.sub-menu-level-1').stop().fadeIn(300); 

 $(this).find('ul.sub-menu-level-1').siblings('a').css('borderBottom','2px solid #c09551');



},function(){

  $(this).find('ul.sub-menu-level-1').stop().fadeOut(300); 

  $(this).find('ul.sub-menu-level-1').siblings('a').css('borderBottom','2px solid transparent');


});

$('.blog-header,.front-header,.fixed-header').find('ul.sub-menu-level-1 li').hover(function(){

 $(this).find('ul.sub-menu-level-2').stop().fadeIn(300); 

 $(this).find('ul.sub-menu-level-2').siblings('a').css('borderBottom','2px solid #c09551');



},function(){

  $(this).find('ul.sub-menu-level-2').stop().fadeOut(300); 

  $(this).find('ul.sub-menu-level-2').siblings('a').css('borderBottom','2px solid transparent');
...
//   var myLocation = new google.maps.LatLng(-5.5474707, 119.9461984);
